...
static const char* SemanticErrorMessages[] = {
	...
	[SEMANTIC_BREAK_OUTSIDE_LOOP] = "'break' can only be used inside loops",	[SEMANTIC_CONTINUE_OUTSIDE_LOOP] = "'continue' can only be used inside loops",	[SEMANTIC_RETURN_VALUE_TYPE_MISMATCH] = "Return type '%s' does not match function return type '%s'",
